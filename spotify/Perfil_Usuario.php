...
<body>
 ...
 if ($resultado2->num_rows>0){
  ...
  INNER JOIN me_gusta as gcan 
  INNER JOIN albumes as alb 
  WHERE 
  gcan.idusuario=$usuario and can.idcanciones = gcan.idcancion and alb.idalbumes = can.idalbumes";
  ...
  if ($resultado4->num_rows>0){
	...
	$usuario = $fila->idusuarios;
  $episodios ="SELECT * FROM episodio as epi INNER JOIN me_gusta as gep INNER JOIN podcast as pod WHERE gep.idusuario=$usuario
